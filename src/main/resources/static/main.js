...
var TaskModel = /** @class */ (function () {
    function TaskModel(name, completed, dueDate) {
        this.name = name;
...
var TasksAddComponent = /** @class */ (function () {
    ...
    TasksAddComponent_1 = TasksAddComponent;
    TasksAddComponent.prototype.ngOnInit = function () {
    };
    TasksAddComponent.prototype.onTaskAdd = function (event) {
        var _this = this;
        var task = new _task_model__WEBPACK_IMPORTED_MODULE_3__["TaskModel"](event.target.value, false, TasksAddComponent_1.getTodayAsString());
    ...
    TasksAddComponent.getTodayAsString = function () {
        var today = new Date();
    ...
    var TasksAddComponent_1;
    TasksAddComponent = TasksAddComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
...
module.exports = __webpack_require__(/*! D:\Projects\Java\KyTasks\src\main\frontend\src\main.ts */"./src/main.ts");
